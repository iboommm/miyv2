...
($this->_properties['page'] == $this->_properties['total_pages'] ? ' class="disabled"><a href="javascript:void(0)' : '><a href="' . $this->_build_uri($this->_properties['page'] + 1)) .
...
($this->_properties['page'] == 1 ? ' class="disabled"><a href="javascript:void(0)' : '><a href="' . $this->_build_uri($this->_properties['page'] - 1)) .
